    ...
    <main className="min-h-screen flex items-center justify-center bg-canvas px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted mt-1">System administration</p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="bg-surface border border-border rounded-2xl shadow-card px-6 py-7"
        >
          <h1 className="font-display text-base font-bold text-ink mb-5">Sign in</h1>

          {error && (
            <div className="mb-4 px-3 py-2 rounded-xl bg-dangerbg text-danger text-sm">
              {error}
            </div>
          )}
          ...
          <input
            ...
            className="w-full mb-4 px-3 py-2.5 rounded-xl border border-border bg-surfacealt text-sm text-ink focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
          ...
          <input
            ...
            className="w-full mb-6 px-3 py-2.5 rounded-xl border border-border bg-surfacealt text-sm text-ink focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
            placeholder="••••••••"
          />
